...
def build_markdown_description(wine: dict, current_quantity: int, is_for_todo: bool = True) -> str:
    ...
    # Add additional details for full description, if not for ToDo
    # NOTE: The original WW-main.py did NOT have extra details here for is_for_todo=False
    # This function is primarily for the HA ToDo description.
    ...
    if is_for_todo:
        ...
        # This will be used by the backend to create a 'description' field,
        # but the frontend will now ignore this and build its own display.
