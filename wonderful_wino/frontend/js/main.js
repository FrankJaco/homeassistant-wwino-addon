...
function updateSortIcons() {
    document.getElementById('sortAscIcon').classList.toggle('hidden', currentSortDirection === 'desc');
    document.getElementById('sortDescIcon').classList.toggle('hidden', currentSortDirection === 'asc');
}
