...
def save_tasting_notes_and_image():
    ...
    image_tilt = data.get('image_tilt') # --- NEW: Extract Tilt ---
    ...
    logger.info(f"Updating notes/image for {vivino_url}. Zoom: {image_zoom}, Tilt: {image_tilt}")
        
    # --- UPDATED CALL ---
    if db.update_wine_notes_and_image(vivino_url, tasting_notes, image_url, image_zoom, image_tilt=image_tilt):
